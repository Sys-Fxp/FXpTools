...
echo "========================================================="
echo " Author    : Sys-Fxp47    "
echo " Contact   : +62 812-4489-6793 "
echo " Github    : https://github.com/Sys-Fxp "
echo " Instagram : faturxploit "
echo " Sc yang sudah terinstall akan tersimpan otomatis di Tools ini"
sleep 1
echo
echo "----------------"
echo " 1.  Hack Ig Mbf "
...
echo "--------------"
echo
echo $bi"Pilih Script Berdasarkan Nomor :"
read -p "--•>" pil

if [ $pil = '1' ]
then
git clone https://github.com/Sys-Fxp/mbihack
cd mbihack
